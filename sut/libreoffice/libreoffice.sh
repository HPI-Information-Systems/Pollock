...
#    parameters={"$delimiters$MRG,34,ASCII"}
#    echo "$f" "$parameters"
...
for f in file_double_trailing* file_header* file_multitable* file_no* file_one* file_preamble* file_record* row_extra* row_less* row_more*
do
    to_xlsx "$f"
done
